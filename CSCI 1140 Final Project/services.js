...
function decorative() {
		...
		function changeToDecorative() {
			document.querySelector("#text").innerHTML = "&quot;When you need a mow strip or any other landscaping barrier.  We can accomodate!&quot";
			...
			document.querySelector("#attribute").innerHTML = "Picture from 'https://media.improvenet.craftjack.io/media/Default/landscaping\n/Concrete%20Edging%20Material%20Costs.jpg'";
	}	
}